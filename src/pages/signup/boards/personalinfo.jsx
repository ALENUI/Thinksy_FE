...
export default function Personalinfo() {
  return (
    <>
      <div className="flex  items-center gap-10 h-svh">
        <div className="w-1/2 bg-amber-50 h-2/3"></div>
        <div className="w-1/2 flex flex-col items-center">
          ...
          <form className="w-[90%] flex flex-col gap-3 mt-5 border border-gray-600 rounded-2xl p-5">
